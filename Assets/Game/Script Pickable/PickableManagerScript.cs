...
public class PickableManagerScript : MonoBehaviour
{
    ...
    {
        PickableScript[] pickableObjects = GameObject.FindObjectsByType<PickableScript>(FindObjectsSortMode.None);
    ...
    private void OnPickablePicked(PickableScript pickable)
    {
        ...
        if (pickable._pickableType == PickableTypeScript.PowerUp)
        {
            _powerUpAudio.Play();
            _player?.PickPowerUp();
        }
